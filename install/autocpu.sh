...
data_ip="https://raw.githubusercontent.com/MasPras0/ip/refs/heads/main/ip"
checking_sc() {
...
Exp2=$(curl -sS https://raw.githubusercontent.com/MasPras0/ip/refs/heads/main/ip | grep $ipsaya | awk '{print $3}')
d1=$(date -d "$Exp2" +%s)
d2=$(date -d "$today" +%s)
