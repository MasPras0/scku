...
### INSTALL SCRIPT 
<pre><code>apt update -y && apt install -y wget curl && wget -q https://raw.githubusercontent.com/f4-MasPras0/scku/main/setup.sh && chmod +x setup.sh && ./setup.sh
</code></pre>

### PERINTAH UPDATE 
<pre><code>wget -q https://raw.githubusercontent.com/MasPras0/scku/main/menu/update.sh && chmod +x update.sh && ./update.sh</code></pre>
